...
part of 'jobs_remote_datasource.dart';
...
class _JobsRemoteDataSource implements JobsRemoteDataSource {
  _JobsRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<void> rejectJob(JobActionRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<void> completeJob(int jobId, FormData request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
  ...
  @override
  Future<void> cancelJob(int jobId, Map<String, dynamic> request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
